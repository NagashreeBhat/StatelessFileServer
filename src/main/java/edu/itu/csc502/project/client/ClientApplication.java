package edu.itu.csc502.project.client;
...
import edu.itu.csc502.project.remote.FileServerService;
import edu.itu.csc502.project.server.CacheException;
import edu.itu.csc502.project.server.FileException;
...
public class ClientApplication {
    public static final String HELP = "Available commands:\n" + "ls - Lists the available files\n"
            + "create <filename> <contents> - create a file with the given name and content\n"
            + "open <filename> - Open a file. The file can be modified. Press return to save and exit\n"
            + "edit <filename> <new data> - edit a file with new contents and update local cache\n"
    ...
    public static void main(final String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            System.out.print("Enter the IP address of the server [" + host + "]");
            ...
            int port = 10800;
            System.out.print("Enter Port Number or default no. is [" + port + "]");
            scannerInput = scanner.nextLine();
